  ...
  return (
    <div className="h-fit flex transition-all items-start">
      <DonutChart
        ...
        index="name"
        colors={["blue-400", "white", "blue-600", "blue-700", "blue-800"]}
        showAnimation={true}
...
const customTooltip = ({
  ...
  return (
    <div className="ml-[100px] text-white w-fit dark:bg-muted/60 backdrop-blur-md bg-background/60 !rounded-lg p-2 shadow-2xl">
